function plotCurrentEvaluationAstar2(DiscOB,goal,start,firstTime,x,y,lastTime,TrackPath,sizeCell,rows,cols)
...
elseif lastTime==0
    ...
    rectangle('Position',[x,y,sizeCell,sizeCell],'FaceColor',[1 1 1],'EdgeColor','black')
else
