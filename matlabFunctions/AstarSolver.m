function [msg,d,TrackPath,TrackHeading,J,GeneralIter]=AstarSolver(parameters,hObject, handles)
...
h=manhattanHeuristic+tieBreaking(manhattanHeuristic,rows+cols);
   ...
   F_NoComb=size(Neighborhood,1);
        ...
        for i=1:F_NoComb
            ...
            if ClosedSet(successor.RobotsCurrentPos(1),successor.RobotsCurrentPos(2))~=1
                ...
                successor.CostEvaluation = successor.augmentedMovementsCost+manhattanHeuristic+tieBreaking(manhattanHeuristic,rows+cols);
